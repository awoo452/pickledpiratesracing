...
## [0.1.130] - 2026-03-27
### Changed
- Added bundler-audit to the CI security scans.
- Updated dependencies: rails 8.1.3, thruster 0.1.20, action_text-trix 2.1.18, json 2.19.3, bigdecimal 4.1.0, net-imap 0.6.3.
...
## [0.1.128] - 2026-03-22
### Added
- Added Bundler Audit config, gem, and binstub for CI checks.
...
## [0.1.123] - 2026-03-20
### Fixed
- Switched cart item tests to the correct route helper names.

## [0.1.122] - 2026-03-20
### Fixed
- Updated cart route helpers in controller tests.
- Adjusted part disclaimer acceptance coverage to match validation behavior.
...
- Updated AWS SDK internals: aws-sdk-core 3.244.0, aws-sdk-kms 1.123.0, aws-partitions 1.1228.0.
...
## [0.1.117] - 2026-03-19
### Changed
- Disabled Active Storage variant processing to avoid image_processing warnings.
- Added a Procfile to declare the Puma web process.
